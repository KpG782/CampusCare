...
import 'academic_success_page_copy_model.dart';
export 'academic_success_page_copy_model.dart';

class AcademicSuccessPageCopyWidget extends StatefulWidget {
  const AcademicSuccessPageCopyWidget({super.key});

  static String routeName = 'AcademicSuccess_pageCopy';
  static String routePath = '/academicSuccessPageCopy';

  @override
  State<AcademicSuccessPageCopyWidget> createState() =>
      _AcademicSuccessPageCopyWidgetState();
}

class _AcademicSuccessPageCopyWidgetState
    extends State<AcademicSuccessPageCopyWidget> {
  late AcademicSuccessPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcademicSuccessPageCopyModel());
                              ...
                              Padding(
                                ...
                                child:
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Text(
                                      valueOrDefault<String>(
                                        textMentalResources1Record?.description,
                                        'empty',
                                      ),
