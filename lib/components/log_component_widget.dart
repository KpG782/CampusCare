...
import 'log_component_model.dart';
export 'log_component_model.dart';

class LogComponentWidget extends StatefulWidget {
  const LogComponentWidget({
    super.key,
    this.parameter1,
    this.parameter2,
  ...
  @override
  State<LogComponentWidget> createState() => _LogComponentWidgetState();
}

class _LogComponentWidgetState extends State<LogComponentWidget> {
  late LogComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogComponentModel());
